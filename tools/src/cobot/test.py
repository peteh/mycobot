...
radians = [1, 1, 1, 1, 1, 1]
mycobot.send_radians(radians, 20)
...
coords = [160, 160, 160, 0, 0, 0]
mycobot.send_coords(coords, 20, 0)
print("::send_coords() ==> send coords {}, speed 70, mode 0\n".format(coords))
time.sleep(3)
...
mycobot.send_angle(Angle.J1.value, 90, 20)
...
mycobot.send_coord(Coord.X.value, -40, 20)
